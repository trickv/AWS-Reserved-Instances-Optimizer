...
rates = {'us-east-1': {'m1.small': {'hourly': .06, 'hu-1y': (195, .016)},
        ...
        'ap-southeast-1': {'m1.small': {'hourly': .065, 'hu-1y': (185, .024)},
                           'm1.medium': {'hourly': .13, 'hu-1y': (370, .048)},
                           'm1.large': {'hourly': .26, 'hu-1y': (739, .095)},
                           'm1.xlarge': {'hourly': .52, 'hu-1y': (1478, .190)},
                           'm3.xlarge': {'hourly': .55, 'hu-1y': (1648, .208)},
                           'm3.2xlarge': {'hourly': 1.10, 'hu-1y': (3296, .416)},
                           't1.micro': {'hourly': .02, 'hu-1y': (62, .008)},
                           'm2.xlarge': {'hourly': .46, 'hu-1y': (821, .119)},
                           'm2.2xlarge': {'hourly': .92, 'hu-1y': (1642, .238)},
                           'm2.4xlarge': {'hourly': 1.84, 'hu-1y': (3284, .476)},
                           'c1.medium': {'hourly': .165, 'hu-1y': (492, .061)},
                           'c1.xlarge': {'hourly': .66, 'hu-1y': (1968, .244)},
                       },
         }
